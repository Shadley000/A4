...
public class PageUniqueAlarms extends Page
{

    public PageUniqueAlarms()
    {
    ...
    public ReportBean build(Connection connection, HttpServletRequest request) throws Exception
    {
        ...
        reportBean.setDataObject(ReportBean.DO_ALARM_TYPE_HISTOGRAM,AlarmsDB.getUniqueAlarms( connection,  userBean));
        return reportBean;
    }

    public String getName(LabelsBean labelsBean)
    {
        return labelsBean.getUnique_alarms();
    }
}

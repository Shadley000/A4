...
public class PageAlarmsVolumeByPriority extends Page
{

    public PageAlarmsVolumeByPriority()
    {
    ...
    public ReportBean build(Connection connection, HttpServletRequest request) throws Exception
    {
        ...
        ReportBean reportBean = new ReportBean("/AlarmsVolumeByPriority.jsp",getName(userBean.getLabelsBean()));
    ...
    {
        return labelsBean.getAlarms_by_Priority();
    }
}

...
import com.shadley000.alarms.pages.PageErrorLog;
...
} else
{
      ...
      out.write("                ");
   {
      ...
      out.print(userBean.getLabelsBean().getFileName());
      out.write("</TH> \n");
      out.write("                        <TH>");
      out.print(userBean.getLabelsBean().getLines());
      out.write("</TH> \n");
      out.write("                        <TH>");
      out.print(userBean.getLabelsBean().getInserted());
      out.write("</TH> \n");
      out.write("                        <TH>");
      out.print(userBean.getLabelsBean().getSkipped());
      out.write("</TH> \n");
      out.write("                        <TH>");
      out.print(userBean.getLabelsBean().getErrors());
      out.write("</TH> \n");
      out.write("                    </TR>\n");
      out.write("                    ");
      ...
      out.print( bean.getloadDate());
      out.write("</TD>\n");
      out.write("                        <TD align=\"left\">");
      out.print( bean.getFilename());
      out.write("</TD>\n");
      out.write("                        <TD>");
      out.print(bean.getDataLines());
      out.write("</TD>\n");
      out.write("                        <TD>");
      out.print( bean.getDataInserted());
      out.write("</TD>\n");
      out.write("                        <TD>");
      out.print( bean.getDataSkipped());
      out.write("</TD>\n");
      out.write("                        <TD>");
      out.print( bean.getDataError());
      out.write("\n");
      out.write("                            ");
      ...
      out.write("\" value=\"");
      out.print( PageErrorLog.class.getName());
      out.write("\">\n");
      out.write("                                    <INPUT type=\"hidden\" name =\"");
      out.print( IConstants.PARAM_FILE_ID);
      out.write("\" value=\"");

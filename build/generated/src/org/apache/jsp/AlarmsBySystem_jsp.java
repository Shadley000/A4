...
import com.shadley000.alarms.pages.PageUniqueAlarms;
...
public final class AlarmsBySystem_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      out.write("                ");
{
      ...
      out.print(IConstants.PARAM_MODE);
      out.write("\" value=\"");
      out.print(IConstants.PARAM_SYSTEM);
      out.write("\" onchange=\"this.form.submit()\" ");
      out.print(systemChecked);
      out.write(">\n");
      out.write("                    ");
      out.print(userBean.getLabelsBean().getSystem());
      out.write("\n");
      out.write("                    </input>\n");
      out.write("                    <input type=\"radio\" name=\"");
      out.print(IConstants.PARAM_MODE);
      out.write("\" value=\"");
      out.print(IConstants.PARAM_SUBSYSTEM);
      out.write("\"  onchange=\"this.form.submit()\" ");
      out.print(subSystemChecked);
      out.write(">\n");
      out.write("                    ");
      out.print(userBean.getLabelsBean().getSubsystem());
      out.write("\n");
      out.write("                    </input>\n");
      out.write("                    <input type=\"radio\" name=\"");
      out.print(IConstants.PARAM_MODE);
      out.write("\" value=\"");
      out.print(IConstants.PARAM_MESSAGE_TYPE);
      out.write("\"  onchange=\"this.form.submit()\" ");
      out.print(messageTypeChecked);
      out.write(">\n");
      out.write("                    ");
      out.print(userBean.getLabelsBean().getType());
      out.write("\n");
      out.write("                    </input>\n");
      out.write("                </FORM>\n");
      out.write("                <BR>\n");
      ...
      out.write("\" value=\"");
      out.print( PageUniqueAlarms.class.getName());
      out.write("\">\n");
      out.write("                                <INPUT type=\"hidden\" name =\"");
      out.print( IConstants.PARAM_SYSTEM);
      out.write("\" value=\"");
      out.print( classification.getSystem());
      out.write("\">\n");
      out.write("                                <input type=\"image\"  id=\"button\" src=\"images\\Magnifier.ico\" alt=\"");
      out.print( userBean.getLabelsBean().getGo());
      ...
      out.write("\n");
      out.write("                        <TD align=\"left\">");
      out.print( classification.getSubSystem());
      out.write("</TD>\n");
      out.write("                            ");
      ...
      out.write("</TD>\n");
      out.write("                        <TD align=\"left\">");
      out.print( classification.getMessageType());
      out.write("</TD>\n");
      out.write("                            ");
